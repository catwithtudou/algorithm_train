...
// 根据左右儿子的信息，更新当前节点的信息
func (t segSquares) maintain(o int) {
	lo, ro := &t[o<<1], &t[o<<1|1]
...
// 仅更新节点信息，不下传懒标记 todo
func (t segSquares) do(o, v int) {
	t[o].minCover += v
	t[o].todo += v
}

// 下传懒标记 todo
func (t segSquares) spread(o int) {
	v := t[o].todo
	if v != 0 {
		t.do(o<<1, v)
		t.do(o<<1|1, v)
...
// 建树
func (t segSquares) build(xs []int, o, l, r int) {
	t[o].l, t[o].r = l, r
	t[o].todo = 0
	if l == r {
		t[o].minCover = 0
...
// 区间更新
func (t segSquares) update(o, l, r, v int) {
	if l <= t[o].l && t[o].r <= r {
		t.do(o, v)
		return
	}
...
func separateSquaresII(squares [][]int) float64 {
	...
	t := make(segSquares, 2<<bits.Len(uint(n-1)))
	t.build(xs, 1, 0, n-1)
